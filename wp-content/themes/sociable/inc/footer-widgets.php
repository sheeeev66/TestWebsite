...
class Sociable_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'sociable';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'sociable' ), $i ),
...
// Initialize.
$sociable_footer_widgets = new Sociable_Footer_Widgets();
