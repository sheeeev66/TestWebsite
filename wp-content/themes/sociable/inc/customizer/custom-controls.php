 ...
 */
class Sociable_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Sociable_Dropdown_Category_Control extends WP_Customize_Control {
...
class Sociable_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Sociable_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="sociable-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Sociable_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Sociable_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="sociable-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'sociable' ); ?>" class="sociable-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
