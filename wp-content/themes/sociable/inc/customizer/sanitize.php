...
if ( ! function_exists( 'sociable_sanitize_select' ) ) :
	/**
	 ...
	 */
	function sociable_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'sociable_sanitize_image' ) ) :
	/**
	 ...
	 */
	function sociable_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'sociable_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function sociable_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'sociable_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Sociable 1.0.0
	*/
	function sociable_sanitize_page( $input ) {
...
if ( ! function_exists( 'sociable_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Sociable 1.0.0
	 ...
	 */
	function sociable_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'sociable_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Sociable 1.0.0
	 */
	function sociable_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if( ! function_exists( 'sociable_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Sociable 1.0.0
	 */
	function sociable_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'sociable_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function sociable_santize_allow_tag( $input ) {
 ...
 * @return boolean    
 */
function sociable_sanitize_switch_control( $input ) {
...
if ( ! function_exists( 'sociable_sanitize_sortable' ) ) :
	/**
	...
	* @since Sociable 1.0.0
	*/
	function sociable_sanitize_sortable( $input ) {
