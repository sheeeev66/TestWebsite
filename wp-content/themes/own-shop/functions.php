...
function own_shop_scripts() {
	...
	wp_enqueue_style( 'own-shop-main', get_template_directory_uri() . '/css/style-main.min.css', array(), wp_get_theme()->get('Version'));
	wp_enqueue_style( 'blocks-frontend', get_template_directory_uri() . '/css/blocks-frontend.min.css', array(), wp_get_theme()->get('Version'));
