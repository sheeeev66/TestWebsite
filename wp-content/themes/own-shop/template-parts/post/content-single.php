        ...
        <div class="blog-post">
            ...
            <?php
                if( is_rtl() ) :
                    ?>
                        <div class="meta">
                            <span class="meta-item date-single"><?php the_time(get_option('date_format')) ?> : <?php esc_html_e('Posted on','own-shop'); ?></span>
                           
                            <span class="meta-item author-single"><a class="author-post-url" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) ?>"><?php the_author() ?></a> : <?php esc_html_e('Posted by','own-shop'); ?></span>

                             <span class="meta-item comments-single"><a class="post-comments-url" href="<?php the_permalink() ?>#comments"><?php comments_number('0','1','%'); ?></a> : <?php esc_html_e('Comments','own-shop'); ?> </span>
