...
2. Type in Own Shop in the search form and press the 'Enter' key on your keyboard.
3. Click on 'Install' button to install and 'Activate' button to use.

= Where can I find the documentation of this theme?

1. Go to https://www.spiraclethemes.com/own-shop-documentation/



== Copyrights =
Own Shop WordPress Theme, Copyright 2021 Spiracle Themes
...
== Important Note ==
Own Shop WordPress theme supports menu level of depth 3 only.
...
Malihu jquery custom scrollbar plugin 3.1.5
Copyright (c) 2016 Manos Malihutsakis
License: MIT
...
Class Login Designer Toggle Control
Copyrights Rich Tabor
License: GPL v3.0
https://gist.github.com/richtabor/59afeeef9e54a9f3c2708c552773d84f

TRT Customizer Pro
Copyrights Justin Tadlock
License: GPL v2.0+
...
Background Image, Copyright Benjamin Voros
License: CC0 1.0 Universal (CC0 1.0)
Source: https://stocksnap.io/photo/blue-denim-BWPRK5DEF0

Women Bags Image
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1093613

Jewellery Image, Copyright Oble
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1025089

Shoes Image
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1341122